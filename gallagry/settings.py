...
import os
findhere = lambda s:os.path.join(os.path.dirname(os.path.abspath(__file__)),s)
...
MEDIA_ROOT = os.path.split(os.path.curdir)[0]
...
SECRET_KEY = 'pv#8q_my-5bkg$7_ij@d38h5^^_zyv2fng_vnuo7ioy%7684qf'

# ***** nothing above this line changes or is updated *****
...
ROOT_URLCONF = 'gallagry.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'gallagry.wsgi.application'
